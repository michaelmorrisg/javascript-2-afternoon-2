...
function divider(numbersArray){
  ...
  superArray.push(evensArray,oddsArray);
  return superArray;
}//Code Here
...
function finder(array){
  let dog = getRandomArbitrary();
    if(array.includes(dog)){
      return true
    } else {
      return false
    }
...
stressed(devMountainEmployees);//Code Here
...
users.push(user1,user2,user3)//Code Here
